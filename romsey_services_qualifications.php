...
<div class="col-md-6">
  <section>
		...
		<p>Our tree surgery services include;</p>
		<ul>
		<li> pruning and shaping</li>
		<li> thinning and dead-wooding</li>
		<li>dangerous branch removal</li>
		<li>pollarding</li> 
		<li>tree felling and dismantling.</li>
		 </ul>
		<p>Other services include;</p> 
		<ul>
		<li>hedge trimming</li>
		<li>tree and hedge planting</li>
		<li>tree assessment (for decay)</li>
		<li>help and advice on protected trees and talking to the local authority and utility companies on your behalf.</li>
		</ul>
	...
	<hr>
<p>We are NPTC qualified (National Proficiency Test Council), which is the industry recognised qualification in chainsaw use, tree felling, and tree climbing.</p>
<p>We have Public Liability insurance to the value of £5Million.</p>
<p>We make sure all tree work carried out to BS3998 standards.</p>

<h2>How does the process work:</h2>
<hr>

<p>Tree Inspection</p>
<p>As part of the quotation process we carry out a visual inspection to determine any problems or causes for concern e.g. presence of decay, deadwood, problem or defective branches etc. We discuss your requirements and offer our recommendation for work required.</p>

<p>Written quotation</p>
Following our initial visit to inspect the tree, we will supply you with a free written quotation detailing our findings and recommendations for work to be completed.</p>

<p>Commencing work</p>
Once our quotation has been accepted we will schedule the works to begin on a date that is convenient for you.</p>

<ul>
<li>A risk assessment is completed before work begins</li>
<li>All operatives hold relevant NPTC qualifications for operating equipment (National proficiency Test Council)</li>
<li>Each operative wears PPE (personal protective equipment)</li>
<li>Climbing and lowering equipment is used</li>
<li>Health &amp; safety guidelines are followed</li>
</ul>

<p>Completion of work</p>
<ul>
<li>Once a job has been completed, all brush and timber will be removed and the site will be left clean and tidy and safe.</li>
<li>All brush is recycled for wood chip mulch. </li>
<li>All large timber is recycled for firewood or wood carving.</li>
</ul>
</div>
